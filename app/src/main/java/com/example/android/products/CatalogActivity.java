...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertProduct() {
        ...
        // and cup's product attributes are the values.
        ContentValues values = new ContentValues();
        values.put(ProductEntry.COLUMN_NAME, "Cup");
        values.put(ProductEntry.COLUMN_SUPPLIER_NAME, "CupStore");
        values.put(ProductEntry.COLUMN_SUPPLIER_EMAIL, "CupStore@mail.com");
        values.put(ProductEntry.COLUMN_QUANTITY, 3);
        values.put(ProductEntry.COLUMN_PRICE, 7);

        // Insert a new row for Cup into the provider using the ContentResolver.
        // Use the {@link ProductEntry#CONTENT_URI} to indicate that we want to insert
        // into the products database table.
        // Receive the new content URI that will allow us to access Cup's data in the future.
